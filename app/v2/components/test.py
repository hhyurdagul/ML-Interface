...
class CustomizeTrainsetComponent:
    ...
    def attach_lookback(self):
        ...
        self.seasonal_period_var = tk.IntVar()
        ...
        seasonal_lookback_entry_1 = tk.Entry(self.customize_train_set_frame, textvariable=self.seasonal_period_var, width=9, state=tk.DISABLED)
