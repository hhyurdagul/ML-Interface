...
class Hybrid:
    def __init__(self):
        ...
        ttk.Entry(train_frame, textvariable=self.period_size).grid(column=1, row=3)

        ttk.Button(train_frame, text="Create Model", command=self.createModel).grid(column=2, row=3)
